...
public interface PortfolioSystem {
  ...
  */
  ...
  /**
   * Record a purchase of the named asset if available funds greater than or equal the total value of the assets (stock
   ...
   */
  boolean purchaseAsset(String assetSymbol, double amount) throws IOException, ParseException;
   ...
   * our portfolio)
   */
  boolean sellAsset(String assetSymbol, double amount) throws IOException, ParseException;
   ...
   */
  List<String> getTrendingStocks(String region) throws IOException, ParseException;
   ...
   */
  String getExchangeSummary(String region, String exchange) throws IOException, ParseException;
   ...
   * portfolio.
   */
  List<AssetQuote> getAssetInformation(List<String> assetNames) throws IOException, ParseException;
   ...
   */
  double getPortfolioValue() throws ParseException, IOException;
   ...
   */
  String listAllInvestments() throws IOException, ParseException;
   ...
   */
  String listPortfolioAssetsByType(String assetType) throws IOException, ParseException;
   ...
   */
  String listPortfolioAssetsByName(List<String> assetNames) throws IOException, ParseException;
